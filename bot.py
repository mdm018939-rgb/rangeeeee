...
print("🤖 অল-হিট মনিটরিং বট চালু হয়েছে। প্রতি ২ সেকেন্ড পর পর সব নতুন মেসেজ চেক করা হচ্ছে...")
first_run = True
...
while True:
            ...
            if json_data.get("meta", {}).get("code") == 200:
                ...
                for hit in hits:
                    ...
                    if current_hit_time:
                        ...
                        if uid not in processed_timestamps:
    ...
    # নতুন রেসপন্সের জন্য ২ সেকেন্ড বিরতি
    time.sleep(2)
